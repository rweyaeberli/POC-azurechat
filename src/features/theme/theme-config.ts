...
export const AI_DISCLAIMER = "Alle Inhalte, die von Aeberli ChatGPT bereitgestellt werden, dienen als Unterstützung und Inspiration. Bitte beachte, dass die Künstliche Intelligenz gelegentlich fehlerhafte oder unvollständige Angaben machen kann. Daher ist es unerlässlich, alle Informationen sorgfältig zu prüfen, bevor sie verwendet oder veröffentlicht werden. Aeberli übernimmt keine Haftung für Schäden, die durch ungeprüfte Nutzung der bereitgestellten Inhalte entstehen.";
